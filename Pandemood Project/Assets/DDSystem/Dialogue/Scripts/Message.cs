...
public class Message : MonoBehaviour
{
    ...
    private void AddDialogues()
    {
        ...
        dialogTexts[0][0].Add(new DialogData("/color:orange/You/color:white/: Ouch! Where am I? What does it mean?", "Gianfilippo"));
        ...
        dialogTexts[0][1].Add(new DialogData("/color:orange/You/color:white/: Well... Actually...", "Gianfilippo"));
        ...
        dialogTexts[1][0].Add(new DialogData("/color:maroon/Friend/color:white/: Hey, you're finally here, we were waiting for you!", "Amico"));
        dialogTexts[1][0].Add(new DialogData("/color:orange/You/color:white/: Ehm, no, I...", "Gianfilippo"));
        dialogTexts[1][0].Add(new DialogData("/color:maroon/Friend/color:white/: Come on! What are you waiting for? Come in and have fun with us!", "Amico"));
        ...
        dialogTexts[1][4].Add(new DialogData("/color:yellow/Lumineo/color:white/: This portal allows you to go upstairs, press and hold down the /size:up/jump/size:init/ button.", "Lumineo"));
        
        dialogTexts[2][0].Add(new DialogData("/color:orange/You/color:white/: Where am I?", "Gianfilippo"));
        dialogTexts[2][0].Add(new DialogData("/color:orange/You/color:white/: Is anybody there?!", "Gianfilippo"));
        dialogTexts[2][0].Add(new DialogData("/color:orange/You/color:white/: Lumineo?", "Gianfilippo"));
        dialogTexts[2][0].Add(new DialogData("/color:orange/You/color:white/: What am I supposed to do now?", "Gianfilippo"));
        
        dialogTexts[2][1].Add(new DialogData("/color:orange/You/color:white/: Lumineo! Where were you?", "Gianfilippo"));
        dialogTexts[2][1].Add(new DialogData("/color:yellow/Lumineo/color:white/: I've always been here with you!", "Lumineo"));
        dialogTexts[2][1].Add(new DialogData("/color:orange/You/color:white/: But I didn't see you, I felt so alone... so...", "Gianfilippo"));
        dialogTexts[2][1].Add(new DialogData("/color:yellow/Lumineo/color:white/: Sad?", "Lumineo"));
        dialogTexts[2][1].Add(new DialogData("/color:orange/You/color:white/: Right...", "Gianfilippo"));
        ...
        dialogTexts[3][0].Add(new DialogData("/color:orange/You/color:white/: I... I can explain...", "Gianfilippo"));
        dialogTexts[3][0].Add(new DialogData("/color:red/Mom/color:white/: Well, let's hear!", "Mamma"));
        dialogTexts[3][0].Add(new DialogData("/color:orange/You/color:white/: I saw a light and went out, then I fell into the sewers...", "Gianfilippo"));
        ...
        dialogTexts[4][0].Add(new DialogData("/color:orange/You/color:white/: What? You can talk?", "Gianfilippo"));
        dialogTexts[4][0].Add(new DialogData("/color:yellow/???/color:white/: If you can talk, I can do it too...", "Lumineo"));
        dialogTexts[4][0].Add(new DialogData("/color:orange/You/color:white/: Okay, but... What are you? Why did you bring me here?", "Gianfilippo"));
        ...
        dialogTexts[4][0].Add(new DialogData("/color:orange/You/color:white/: Lost emotions?", "Gianfilippo"));
        ...
        dialogTexts[4][0].Add(new DialogData("/color:orange/You/color:white/: Oh... okay...", "Gianfilippo"));
        ...
        dialogTexts[4][4].Add(new DialogData("/color:orange/You/color:white/: Mmmh.. Maybe I should follow Lumineo... ", "Gianfilippo"));
        ...
        dialogTexts[5][0].Add(new DialogData("/color:orange/You/color:white/: ...", "Gianfilippo"));
        dialogTexts[5][0].Add(new DialogData("/color:orange/You/color:white/: I've learned that there can't be courage, without fear...", "Gianfilippo"));
        dialogTexts[5][0].Add(new DialogData("/color:orange/You/color:white/: And happiness goes along with a little tear...", "Gianfilippo"));
        dialogTexts[5][0].Add(new DialogData("/color:orange/You/color:white/: ...and it's okay to get angry, sometimes, as long as you don't let it control you.", "Gianfilippo"));
        dialogTexts[5][0].Add(new DialogData("/color:orange/You/color:white/: But all these emotions color our lives, and we can't live without all of them.", "Gianfilippo"));
        dialogTexts[5][0].Add(new DialogData("/color:orange/You/color:white/: Thank you, Lumineo!", "Gianfilippo"));
