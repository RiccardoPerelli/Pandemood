...
namespace Enigma_Tristezza
{
    public class TimingCrackedGlass : MonoBehaviour
    {
        ...
        private IEnumerator ChangeCharacterPosition()
        {
            ...
            character.GetComponentInChildren<Character.Character_Controller.AnimationCharacterController>().enabled = false;
            ...
            character.GetComponent<PhysicsCharacterControllerWater>().m_MovementSmoothing = 0.15f;
            character.GetComponent<PhysicsCharacterControllerWater>().SwimSpeed = 0.2f;
