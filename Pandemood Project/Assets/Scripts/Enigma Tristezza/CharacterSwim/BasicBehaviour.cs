...
public class BasicBehaviour : MonoBehaviour
{
	...
	private bool crouch;
	private bool isWalkingOnZ = true;
	...
	public void SetH(float hor){ h = hor; } 
	...
	void Update()
	{
		...
		if(!canVertical && isWalkingOnZ)
			this.gameObject.GetComponent<Rigidbody>().constraints = RigidbodyConstraints.FreezePositionX | RigidbodyConstraints.FreezeRotationX | RigidbodyConstraints.FreezeRotationY | RigidbodyConstraints.FreezeRotationZ;
		else if (!canVertical && !isWalkingOnZ)
