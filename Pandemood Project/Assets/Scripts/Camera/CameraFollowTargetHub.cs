...
public class CameraFollowTargetHub : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (target.parent.parent.gameObject.GetComponent<ChangeDirection>() != null) {
            target.parent.parent.gameObject.GetComponent<ChangeDirection>().OnDirectionChanged += TurnOf90Degrees;
        }
