...
namespace Character.Character_Controller
{
    public class AnimationCharacterController : MonoBehaviour
    {
        ...
        private bool _isPushingVibrating;
        ...
        {
            if (!_isPushing && _isPushingVibrating)
            {
                MyGamepad.StopVibration();
                _isPushingVibrating = false;
            }
            ...
            else if (_isPushing)
            {
                ...
                if (!_isPushingVibrating)
                {
                    MyGamepad.SetVibration(MyGamepad.Pushing);
                    _isPushingVibrating = true;
                }
