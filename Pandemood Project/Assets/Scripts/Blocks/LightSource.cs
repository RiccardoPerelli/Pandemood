...
namespace Blocks
{
    public class LightSource : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                Debug.Log("Distanza: " + Vector3.Distance(tmpPos, obj.transform.position));
        ...
        public void TurnOnLight(object sender, EventArgs args)
        {
            Debug.Log("Press");
        ...
        public void TurnOffLight(object sender, EventArgs args)
        {
